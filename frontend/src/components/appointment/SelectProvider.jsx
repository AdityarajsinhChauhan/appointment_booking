  ...
  return (
    <div className="p-5 relative">
      <div className="flex items-center border-b border-gray-300 pb-5">
        ...
        className={`py-3 px-5 transition-all duration-150 border font-bold border-sky-700 rounded-lg ${selectedProvider ? "text-white bg-linear-to-r from-sky-600 via-sky-700 to-sky-700 cursor-pointer hover:from-white hover:via-white hover:to-white hover:text-sky-700" : "bg-white cursor-no-drop"}`}
      >
        ...
        <h2 className="font-bold text-xl my-5">Select Provider</h2>
      ...
      {loading ? (
        ...
        <div className="grid md:grid-cols-4 grid-cols-2">
          {providers.map((provider) => (
            <div
              key={provider.id}
              className={`border transition-all duration-150 group hover:border-sky-600 hover:shadow rounded-xl p-3 md:p-5 flex flex-col min-w-48 gap-1 md:gap-2 mt-5 mr-5 
            ...
            >
              <div onClick={()=>setSelectedProvider(provider)} className={`flex items-center gap-3 cursor-pointer
                ...
                <div className=" flex flex-col ">
                  <span className={`text-base md:text-lg transition-all font-bold duration-150 group-hover:text-sky-700
              ...
              <div onClick={()=>setSelectedProvider(provider)} className="flex items-center gap-1 md:gap-3 px-1 cursor-pointer">
                ...
                <span className="bg-gray-500 rounded-full text-sm md:text-base w-2 h-2"></span>
