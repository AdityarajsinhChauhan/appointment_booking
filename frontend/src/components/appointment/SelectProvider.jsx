    ...
    <div className="p-5 relative">
      ...
      {loading ? <Spinner/> : <div className="flex flex-wrap">
        {providers.map((provider) => (
          <div key={provider.id} onClick={()=>setSelectedProvider(provider)}  className={`border  rounded-xl p-10 flex flex-col min-w-48 gap-3 mt-5 mr-5 ${selectedProvider?.id == provider.id ? "border-black" : "border-gray-300"}`}>
          <div className="flex items-center gap-3">
            ...
            <div className=" flex flex-col">
              ...
              <span className="text-gray-600">{provider.experience_years} Years experience</span>
            </div>
          </div>
